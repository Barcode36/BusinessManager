...
public class MaterialPropertyTypes {
    ...
    public MaterialPropertyTypes(SimpleIntegerProperty propertyTypeID, SimpleStringProperty PropertyTypeName) {
    ...
    public static List<MaterialPropertyTypes> getMaterialPropertyTypes(HikariDataSource ds) {
        
        //Create list
        List<MaterialPropertyTypes> materialPropertyTypes = new ArrayList<>();
        ...
        try {
            ...
            while(rs.next()){
                ...
                MaterialPropertyTypes property = new MaterialPropertyTypes(propertyTypeID, propertyTypeName);
                
                materialPropertyTypes.add(property);
