...
CREATE TABLE `Orders` (
  ...
  `OrderCosts` float(5,2) NOT NULL,
  `OrderWeight` float(7,2) DEFAULT NULL,
  `OrderSupportWeight` float(7,2) NOT NULL,
...
-- Dump completed on 2018-10-02 16:48:13
